...
{id: 121, name: 'Ярославль'}
	...
	$.mockjax({ // эмулятор ajax ответов для тарифов
		url: '/tarifs/',
		response: function() {
			this.responseText = '<article class="tarif_box tarif_item" data-tarif="ТВ"> <div class="tarif_item_description"> <div class="tarif_item_top"> <div class="head"> <div class="title-cat"> <h3 class="ctitle"><a href="#" title="">Моно Min + WiFi</a></h3> </div> </div> <div class="params"> <div class="params_wrapper"> <div class="speed"> <div class="num">100</div> <p>Мбит<br>сек</p> </div> <div class="channels"> <div class="num">222</div> <p>каналов</p> </div> <div class="price"> <div class="price_top"> <div class="num">350</div> <p>руб <br> месяц</p> </div> <div class="price_bottom"> 555 руб/мес </div> </div> </div> </div> </div> </div> <div class="buttons"> <div class="buttons_wrapper"> <a href="#" class="btn-compare to-compare"></a> <a href="#" class="btn-connect btn btn-rounded" data-toggle="modal" data-target="#connect">Подключить</a> <button type="button" class="btn-fav btn-fav-in" title=""></button> </div> </div> <div class="label label-action"><img src="images/label-action3.png" alt="Акция" /></div> </article> <article class="tarif_box tarif_item" data-tarif="Интернет"> <div class="tarif_item_description"> <div class="tarif_item_top"> <div class="head"> <div class="title-cat"> <h3 class="ctitle"><a href="#" title="">Orion 600x</a></h3> </div> </div> <div class="params"> <div class="params_wrapper"> <div class="speed"> <div class="num">80</div> <p>Мбит<br>сек</p> </div> <div class="price"> <div class="price_top"> <div class="num">600</div> <p>руб <br> месяц</p> </div> </div> </div> </div> </div> </div> <div class="buttons"> <div class="buttons_wrapper"> <a href="#" class="btn-compare to-compare"></a> <a href="#" class="btn-connect btn btn-rounded" data-toggle="modal" data-target="#connect">Подключить</a> <button type="button" class="btn-fav to-fav" title=""></button> </div> </div> </article> <article class="tarif_box tarif_item" data-tarif="ТВ"> <div class="tarif_item_description"> <div class="tarif_item_top"> <div class="head"> <div class="title-cat"> <h3 class="ctitle"><a href="#" title="">Домашний интернет и ТВ за 500</a></h3> </div> </div> <div class="params"> <div class="params_wrapper"> <div class="speed"> <div class="num">100</div> <p>Мбит<br>сек</p> </div> <div class="channels"> <div class="num">56</div> <p>каналов</p> </div> <div class="price"> <div class="price_top"> <div class="num">500</div> <p>руб <br> месяц</p> </div> </div> </div> </div> </div> </div> <div class="buttons"> <div class="buttons_wrapper"> <a href="#" class="btn-compare to-compare"></a> <a href="#" class="btn-connect btn btn-rounded" data-toggle="modal" data-target="#connect">Подключить</a> <button type="button" class="btn-fav to-fav" title=""></button> </div> </div> </article>';
		}
	});
