...
{id: 121, name: 'Ярославль'}
	...
	$.mockjax({ // эмулятор ajax ответов
		url: '/reviewers/',
		response: function() {
				this.responseText = '<div class="col-md-6"> <div class="reviewers_item"> <!-- top --> <div class="reviewers_item_top"> <div class="name-rating"> <div class="left"> <p class="name">Переверзев Владислав</p> <p class="date dateicon">16 октября 2016, в 22:00</p> </div> <div class="rating right"> <div class="rate rate-avg green">4.9</div> <div class="rate green"> <span class="cifr">5</span> <div class="tooltip"><span>Качество связи</span></div> </div> <div class="rate green"> <span class="cifr">4</span> <div class="tooltip"><span>Качество       </span></div> </div> <div class="rate yellow"> <span class="cifr">3</span> <div class="tooltip"><span>Качество связи связи</span></div> </div> <div class="rate brown"> <span class="cifr">2</span> <div class="tooltip"><span>Качество связи</span></div> </div> <div class="rate red"> <span class="cifr">1</span> <div class="tooltip"><span>Качество связи</span></div> </div> </div> <div class="clearfix"></div> <div class="length">Пользуюсь услугами более 3х месяцев</div> </div> </div> <!-- body --> <div class="reviewers_item_body"> <p class="title">Достоинства:</p> <div class="text">Цена, Дисплей, Работает при очень низком давлении воды, Розжиг электронный, Индикатор заряда батарей, Мощность с запасом.</div> <p class="title">Недостатки:</p> <div class="text">Их нет. Электролюкс за такие деньги - супер.</div> <p class="title">Комментарий</p> <div class="text">Колонка хорошая. Я устанавливаю и ремонтирую колонки с 2002 года.</div> <p class="more"> <a href="#" class="">Показать продолжение</a> </p> </div> <!-- bottom --> <div class="reviewers_item_bottom like"> <a href="#" class="up">15</a> <a href="#" class="down">3</a> </div> </div> </div>'} });
})
